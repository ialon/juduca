...
?>
								...
								<tr>
									<td <?php echo $this->data['style']['header']; ?>><?php esc_html_e('Information','bookingo'); ?></td>
								</tr>
								<tr><td <?php echo $this->data['style']['separator'][3]; ?>><td></tr>
								<tr>
									<td>
										<?php esc_html_e('Test message sending via "Bookingo - Course Booking System for WordPress" plugin.','bookingo'); ?>
									</td>
								</tr>
