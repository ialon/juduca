...
class BGCBSDate
{
	...
	function formatDateToStandard($date)
	{
		...
		return(date_format(date_create_from_format(BGCBSOption::getOption('date_format'),$date),'d-m-Y'));
	}
	...
	function formatDateToDisplay($date,$sourceFormat='d-m-Y')
	{
		...
		return(date_format(date_create_from_format($sourceFormat,$date),BGCBSOption::getOption('date_format')));
	}
	...
	function formatTimeToStandard($time)
	{
		...
		return(date_format(date_create_from_format(BGCBSOption::getOption('time_format'),$time),'H:i'));
	}
	...
	function formatTimeToDisplay($time,$sourceFormat='H:i')
	{
		...
		return(date_format(date_create_from_format($sourceFormat,$time),BGCBSOption::getOption('time_format')));
	}
